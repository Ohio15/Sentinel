    ...
    <aside className="w-64 bg-surface border-r border-border flex flex-col">
      ...
      <div className="p-6 border-b border-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-text-primary">Sentinel</h1>
            <p className="text-xs text-text-secondary">RMM Platform</p>
          </div>
        </div>
      </div>
            ...
            <li key={item.id}>
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                  ...
                  ((currentPage === 'ticket-detail' || currentPage === 'tickets-kanban' || currentPage === 'tickets-calendar' || currentPage === 'tickets-analytics') && item.id === 'tickets')
...
function ScriptsIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
function InstallationsIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
