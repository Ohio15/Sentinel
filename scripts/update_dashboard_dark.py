#!/usr/bin/env python3
"""Update Dashboard.tsx with dark mode classes"""
...
with open('D:/Projects/Sentinel/src/renderer/pages/Dashboard.tsx', 'w', encoding='utf-8') as f:
    f.write(content)

print("Dashboard.tsx updated with dark mode!")
